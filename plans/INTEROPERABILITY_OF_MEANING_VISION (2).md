...
# A trajectory grounded in research and practice

This vision is not presented as a new theory assembled around a set of
software projects.

It makes visible a longer **research, standardization and engineering
trajectory** whose arguments, evidence and practical experience are
distributed across doctoral and HDR research, interoperability work,
standards-governance activities, experimental demonstrators and
manifestos.

``` text
Scientific foundations
PhD · HDR · interoperability research
        │
        ▼
Interoperability principles
Hypermodels · Semantic Cartography
        │
        ▼
Standardization practice
ASD SSG · strategic standards governance
        │
        ▼
Experimental instruments
Strategic Standards Radar · ArchiCG · BPMNSM
        │
        ▼
Critical exploration
AI fallacies · Inhabiting Babel
        │
        ▼
Human / organizational dimension
Open People Factory
        │
        ▼
...
The detailed initiative pages therefore use two explicit epistemic
levels:

-   **demonstrated / documented foundations** --- mechanisms, practices
    or prototypes that already exist and can be inspected;
-   **research trajectory** --- questions and integrations that the
    instruments are intended to make progressively testable.

This distinction keeps the vision ambitious without presenting future
research questions as already-established capabilities.
...
## Strategic standards governance

International and industrial standards provide long-lived anchors in
volatile technology landscapes. Work with the **ASD Strategic
Standardization Group (ASD SSG)** starts from a practical governance
problem: before a community implements standards-based exchanges,
applications or collaboration processes, it must converge on a coherent
set of standards and maintain that consensus as the ecosystem evolves.

The **Strategic Standards Radar** is the experimental instrument for
this part of the vision. Its original governance grammar combines
adoption rings --- **tracked, candidate, adopted** --- with quadrants
describing the community's strategic relationship to standardization:
**external standards available for use, monitored external developments,
locally developed standards, and active participation in external
standardization**.

The exploration moves from a static chart toward a semantic governance
entry point:
...
strategic positioning
        ↓
governance history & rationale
        ↓
enterprise architecture context
        ↓
process / collaboration impact
        ↓
operational interoperability
```

This makes the radar complementary to the other experimental
instruments:

-   **Strategic Standards Radar** --- *Which standards should govern the
    ecosystem, and why?*
-   **ArchiCG** --- *Where do those standards apply in the enterprise
    and digital ecosystem?*
-   **BPMNSM** --- *How are those choices reflected in processes,
    collaborations, enactment and operations?*

The radar is therefore not merely a visualization of standards maturity.
It is an exploration of **strategic consensus, provenance, context and
evolution**.
