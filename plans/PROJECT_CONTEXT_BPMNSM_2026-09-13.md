...
**Version de continuité :** 2026-09-13\
...
Le dernier baseline complet explicitement confirmé est :
...
Le prochain chantier prioritaire devient l'expérience ArchiMate décrite en section 21. Il ne remplace pas le chantier futur de second `ProjectionProfile`, mais le précède afin de répondre à un besoin concret de réutilisation d'un référentiel ArchiMate et de médiation vers BPMN.
...
Le premier incrément doit donc démontrer l'intégration technique avant de généraliser le modèle pivot ou le repository.

------------------------------------------------------------------------
# Résumé en une phrase

**BPMNSM est un atelier/runtime JavaScript/Vite basé sur bpmn.io qui utilise actuellement BPMN 2.0 XML comme langage pivot, enrichit et projette les référentiels selon des points de vue configurables — d'abord CoC-centric — et ouvre désormais un chantier expérimental ArchiMate visant à préserver les modèles legacy, guider un viewpoint processus CoC et démontrer des transpositions ArchiMate ↔ BPMN explicites, traçables et contestables.**
