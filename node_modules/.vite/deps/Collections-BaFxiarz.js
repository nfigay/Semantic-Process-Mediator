...
var event = /* @__PURE__ */ _mergeNamespaces({
	__proto__: null,
	default: /* @__PURE__ */ getDefaultExportFromCjs$1(componentEventExports)
...
function setLabel(element, text) {
	var semantic = element.businessObject, attr = getLabelAttr(semantic);
	if (attr) if (attr === "categoryValueRef") {
...
function isHorizontal(element) {
	if (!is(element, "bpmn:Participant") && !is(element, "bpmn:Lane")) return;
...
//#endregion
//#region node_modules/ids/dist/index.js
...
var hat = /* @__PURE__ */ getDefaultExportFromCjs(requireHat());
/**
...
//#endregion
export { isFunction as $, classes as A, bind$1 as B, getBusinessObject as C, all as D, isAny as E, matches as F, findIndex as G, every as H, query as I, get as J, flatten as K, remove$1 as L, closest as M, delegate as N, assign as O, event as P, isDefined as Q, domify as R, isLabel as S, is as T, filter as U, debounce as V, find as W, has as X, groupBy as Y, isArray as Z, hasExternalLabel as _, values as _t, hasCompensateEventDefinition as a, keys as at, setLabel as b, hasEventDefinition as c, omit as ct, isHorizontal as d, set as dt, isNil as et, isInterrupting as f, size as ft, getLabel as g, uniqueBy as gt, getExternalLabelMid as h, unionBy as ht, Ids as i, isUndefined as it, clear as j, attr as k, isEventSubProcess as l, pick as lt, getExternalLabelBounds as m, sortBy as mt, indexOf as n, isObject as nt, hasErrorEventDefinition as o, map as ot, DEFAULT_LABEL_SIZE as p, some as pt, forEach as q, remove as r, isString as rt, hasEscalationEventDefinition as s, matchPattern as st, add as t, isNumber as tt, isExpanded as u, reduce as ut, isExternalLabel as v, without as vt, getDi as w, isConnection as x, isLabelExternal as y, assign$1 as z };

//# sourceMappingURL=Collections-BaFxiarz.js.map